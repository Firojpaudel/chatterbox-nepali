...
/* offload API need BIND(C) so by default no _ suffix needed */
#ifdef MKL_ILP64
#define N_OFFLOAD(n) n##_ilp64
#else
#define N_OFFLOAD(n) n##_lp64
#endif

#define dfftw_plan_dft_omp_offload                 N_OFFLOAD(dfftw_plan_dft_omp_offload)
#define dfftw_plan_dft_1d_omp_offload              N_OFFLOAD(dfftw_plan_dft_1d_omp_offload)
#define dfftw_plan_dft_2d_omp_offload              N_OFFLOAD(dfftw_plan_dft_2d_omp_offload)
#define dfftw_plan_dft_3d_omp_offload              N_OFFLOAD(dfftw_plan_dft_3d_omp_offload)
#define dfftw_plan_dft_c2r_omp_offload             N_OFFLOAD(dfftw_plan_dft_c2r_omp_offload)
#define dfftw_plan_dft_r2c_omp_offload             N_OFFLOAD(dfftw_plan_dft_r2c_omp_offload)
#define dfftw_plan_dft_c2r_1d_omp_offload          N_OFFLOAD(dfftw_plan_dft_c2r_1d_omp_offload)
#define dfftw_plan_dft_r2c_1d_omp_offload          N_OFFLOAD(dfftw_plan_dft_r2c_1d_omp_offload)
#define dfftw_plan_dft_c2r_2d_omp_offload          N_OFFLOAD(dfftw_plan_dft_c2r_2d_omp_offload)
#define dfftw_plan_dft_r2c_2d_omp_offload          N_OFFLOAD(dfftw_plan_dft_r2c_2d_omp_offload)
#define dfftw_plan_dft_c2r_3d_omp_offload          N_OFFLOAD(dfftw_plan_dft_c2r_3d_omp_offload)
#define dfftw_plan_dft_r2c_3d_omp_offload          N_OFFLOAD(dfftw_plan_dft_r2c_3d_omp_offload)
#define dfftw_plan_guru_dft_omp_offload            N_OFFLOAD(dfftw_plan_guru_dft_omp_offload)
#define dfftw_plan_guru_dft_c2r_omp_offload        N_OFFLOAD(dfftw_plan_guru_dft_c2r_omp_offload)
#define dfftw_plan_guru_dft_r2c_omp_offload        N_OFFLOAD(dfftw_plan_guru_dft_r2c_omp_offload)
#define dfftw_plan_many_dft_omp_offload            N_OFFLOAD(dfftw_plan_many_dft_omp_offload)
#define dfftw_plan_many_dft_c2r_omp_offload        N_OFFLOAD(dfftw_plan_many_dft_c2r_omp_offload)
#define dfftw_plan_many_dft_r2c_omp_offload        N_OFFLOAD(dfftw_plan_many_dft_r2c_omp_offload)

#define sfftw_plan_dft_omp_offload                 N_OFFLOAD(sfftw_plan_dft_omp_offload)
#define sfftw_plan_dft_1d_omp_offload              N_OFFLOAD(sfftw_plan_dft_1d_omp_offload)
#define sfftw_plan_dft_2d_omp_offload              N_OFFLOAD(sfftw_plan_dft_2d_omp_offload)
#define sfftw_plan_dft_3d_omp_offload              N_OFFLOAD(sfftw_plan_dft_3d_omp_offload)
#define sfftw_plan_dft_c2r_omp_offload             N_OFFLOAD(sfftw_plan_dft_c2r_omp_offload)
#define sfftw_plan_dft_r2c_omp_offload             N_OFFLOAD(sfftw_plan_dft_r2c_omp_offload)
#define sfftw_plan_dft_c2r_1d_omp_offload          N_OFFLOAD(sfftw_plan_dft_c2r_1d_omp_offload)
#define sfftw_plan_dft_r2c_1d_omp_offload          N_OFFLOAD(sfftw_plan_dft_r2c_1d_omp_offload)
#define sfftw_plan_dft_c2r_2d_omp_offload          N_OFFLOAD(sfftw_plan_dft_c2r_2d_omp_offload)
#define sfftw_plan_dft_r2c_2d_omp_offload          N_OFFLOAD(sfftw_plan_dft_r2c_2d_omp_offload)
#define sfftw_plan_dft_c2r_3d_omp_offload          N_OFFLOAD(sfftw_plan_dft_c2r_3d_omp_offload)
#define sfftw_plan_dft_r2c_3d_omp_offload          N_OFFLOAD(sfftw_plan_dft_r2c_3d_omp_offload)
#define sfftw_plan_guru_dft_omp_offload            N_OFFLOAD(sfftw_plan_guru_dft_omp_offload)
#define sfftw_plan_guru_dft_c2r_omp_offload        N_OFFLOAD(sfftw_plan_guru_dft_c2r_omp_offload)
#define sfftw_plan_guru_dft_r2c_omp_offload        N_OFFLOAD(sfftw_plan_guru_dft_r2c_omp_offload)
#define sfftw_plan_many_dft_omp_offload            N_OFFLOAD(sfftw_plan_many_dft_omp_offload)
#define sfftw_plan_many_dft_c2r_omp_offload        N_OFFLOAD(sfftw_plan_many_dft_c2r_omp_offload)
#define sfftw_plan_many_dft_r2c_omp_offload        N_OFFLOAD(sfftw_plan_many_dft_r2c_omp_offload)

#define dfftw_plan_dft_cpu                 N_OFFLOAD(dfftw_plan_dft_cpu)
#define dfftw_plan_dft_1d_cpu              N_OFFLOAD(dfftw_plan_dft_1d_cpu)
#define dfftw_plan_dft_2d_cpu              N_OFFLOAD(dfftw_plan_dft_2d_cpu)
#define dfftw_plan_dft_3d_cpu              N_OFFLOAD(dfftw_plan_dft_3d_cpu)
#define dfftw_plan_dft_c2r_cpu             N_OFFLOAD(dfftw_plan_dft_c2r_cpu)
#define dfftw_plan_dft_r2c_cpu             N_OFFLOAD(dfftw_plan_dft_r2c_cpu)
#define dfftw_plan_dft_c2r_1d_cpu          N_OFFLOAD(dfftw_plan_dft_c2r_1d_cpu)
#define dfftw_plan_dft_r2c_1d_cpu          N_OFFLOAD(dfftw_plan_dft_r2c_1d_cpu)
#define dfftw_plan_dft_c2r_2d_cpu          N_OFFLOAD(dfftw_plan_dft_c2r_2d_cpu)
#define dfftw_plan_dft_r2c_2d_cpu          N_OFFLOAD(dfftw_plan_dft_r2c_2d_cpu)
#define dfftw_plan_dft_c2r_3d_cpu          N_OFFLOAD(dfftw_plan_dft_c2r_3d_cpu)
#define dfftw_plan_dft_r2c_3d_cpu          N_OFFLOAD(dfftw_plan_dft_r2c_3d_cpu)
#define dfftw_plan_guru_dft_cpu            N_OFFLOAD(dfftw_plan_guru_dft_cpu)
#define dfftw_plan_guru_dft_c2r_cpu        N_OFFLOAD(dfftw_plan_guru_dft_c2r_cpu)
#define dfftw_plan_guru_dft_r2c_cpu        N_OFFLOAD(dfftw_plan_guru_dft_r2c_cpu)
#define dfftw_plan_many_dft_cpu            N_OFFLOAD(dfftw_plan_many_dft_cpu)
#define dfftw_plan_many_dft_c2r_cpu        N_OFFLOAD(dfftw_plan_many_dft_c2r_cpu)
#define dfftw_plan_many_dft_r2c_cpu        N_OFFLOAD(dfftw_plan_many_dft_r2c_cpu)

#define sfftw_plan_dft_cpu                 N_OFFLOAD(sfftw_plan_dft_cpu)
#define sfftw_plan_dft_1d_cpu              N_OFFLOAD(sfftw_plan_dft_1d_cpu)
#define sfftw_plan_dft_2d_cpu              N_OFFLOAD(sfftw_plan_dft_2d_cpu)
#define sfftw_plan_dft_3d_cpu              N_OFFLOAD(sfftw_plan_dft_3d_cpu)
#define sfftw_plan_dft_c2r_cpu             N_OFFLOAD(sfftw_plan_dft_c2r_cpu)
#define sfftw_plan_dft_r2c_cpu             N_OFFLOAD(sfftw_plan_dft_r2c_cpu)
#define sfftw_plan_dft_c2r_1d_cpu          N_OFFLOAD(sfftw_plan_dft_c2r_1d_cpu)
#define sfftw_plan_dft_r2c_1d_cpu          N_OFFLOAD(sfftw_plan_dft_r2c_1d_cpu)
#define sfftw_plan_dft_c2r_2d_cpu          N_OFFLOAD(sfftw_plan_dft_c2r_2d_cpu)
#define sfftw_plan_dft_r2c_2d_cpu          N_OFFLOAD(sfftw_plan_dft_r2c_2d_cpu)
#define sfftw_plan_dft_c2r_3d_cpu          N_OFFLOAD(sfftw_plan_dft_c2r_3d_cpu)
#define sfftw_plan_dft_r2c_3d_cpu          N_OFFLOAD(sfftw_plan_dft_r2c_3d_cpu)
#define sfftw_plan_guru_dft_cpu            N_OFFLOAD(sfftw_plan_guru_dft_cpu)
#define sfftw_plan_guru_dft_c2r_cpu        N_OFFLOAD(sfftw_plan_guru_dft_c2r_cpu)
#define sfftw_plan_guru_dft_r2c_cpu        N_OFFLOAD(sfftw_plan_guru_dft_r2c_cpu)
#define sfftw_plan_many_dft_cpu            N_OFFLOAD(sfftw_plan_many_dft_cpu)
#define sfftw_plan_many_dft_c2r_cpu        N_OFFLOAD(sfftw_plan_many_dft_c2r_cpu)
#define sfftw_plan_many_dft_r2c_cpu        N_OFFLOAD(sfftw_plan_many_dft_r2c_cpu)

#define dfftw_plan_dft_omp_offload_impl      N_OFFLOAD(dfftw_plan_dft_omp_offload_impl)
#define dfftw_plan_dft_c2r_omp_offload_impl  N_OFFLOAD(dfftw_plan_dft_c2r_omp_offload_impl)
#define dfftw_plan_dft_r2c_omp_offload_impl  N_OFFLOAD(dfftw_plan_dft_r2c_omp_offload_impl)
#define sfftw_plan_dft_omp_offload_impl      N_OFFLOAD(sfftw_plan_dft_omp_offload_impl)
#define sfftw_plan_dft_c2r_omp_offload_impl  N_OFFLOAD(sfftw_plan_dft_c2r_omp_offload_impl)
#define sfftw_plan_dft_r2c_omp_offload_impl  N_OFFLOAD(sfftw_plan_dft_r2c_omp_offload_impl)
#define dfftw_plan_guru_dft_omp_offload_impl N_OFFLOAD(dfftw_plan_guru_dft_omp_offload_impl)
#define sfftw_plan_guru_dft_omp_offload_impl N_OFFLOAD(sfftw_plan_guru_dft_omp_offload_impl)
#define dfftw_plan_guru_dft_c2r_omp_offload_impl N_OFFLOAD(dfftw_plan_guru_dft_c2r_omp_offload_impl)
#define sfftw_plan_guru_dft_c2r_omp_offload_impl N_OFFLOAD(sfftw_plan_guru_dft_c2r_omp_offload_impl)
#define dfftw_plan_guru_dft_r2c_omp_offload_impl N_OFFLOAD(dfftw_plan_guru_dft_r2c_omp_offload_impl)
#define sfftw_plan_guru_dft_r2c_omp_offload_impl N_OFFLOAD(sfftw_plan_guru_dft_r2c_omp_offload_impl)
